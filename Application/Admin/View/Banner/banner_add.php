	...
	<form action="" method="post" class="form form-horizontal" id="add_form" >
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="" name="banner_name" id="banner_name"/>
			</div>
		</div>
        <div class="row cl">
			<label class="form-label col-xs-4 col-sm-2">上传图片：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <div id="demo" class="demo"><input type="hidden" name="img_url"></div>
            </div>
            <div class="col-3"> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 skin-minimal">
				<div class="check-box" style="padding-left:0px;">
					<input type="text" class="input-text" name="list_order">
				</div>
			</div>
			<div class="col-3"> </div>
		</div>
