...
<div class="page-container">
	<form action="" method="post" class="form form-horizontal" id="add_form">
		<input type="hidden" name="id" value="{$this_recruit.id}">
			...
			<div class="tabCon" style="display:block;">
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-4">
						<input type="text" class="input-text" value="{$this_recruit.position}" name="position" id="position"/>
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">招聘人数：</label>
					<div class="formControls col-xs-8 col-sm-2">
						<input type="text" class="input-text" value="{$this_recruit.number}" name="number" id="number"/>
					</div>
					<div class="col-3"> </div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" class="input-text" value="{$this_recruit.working_hours}" name="working_hours" id="working_hours"/>
					</div>
					<div class="col-3"> </div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-6">
						<input type="text" class="input-text" value="{$this_recruit.address}" name="address" id="address"/>
					</div>
					<div class="col-3"> </div>
				</div>
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-2">
						<input class="input-text" type="text" onfocus="WdatePicker()" name="public_date" value="{$this_recruit.public_date}"/>
					</div>
					<div class="col-3"> </div>
				</div>
			</div>
			<div class="tabCon">
				<div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <script id="editor1" type="text/plain" style="width:100%;height:300px;" name="responsibility">{$this_recruit.responsibility}</script> 
                    </div>
                </div>
			</div>
			<div class="tabCon">
				<div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <script id="editor2" type="text/plain" style="width:100%;height:300px;" name="requirement">{$this_recruit.requirement}</script> 
                    </div>
                </div>
			</div>
			<div class="tabCon">
				<div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9">
                        <script id="editor3" type="text/plain" style="width:100%;height:300px;" name="treatment">{$this_recruit.treatment}</script> 
                    </div>
                </div>
			</div>
		</div>
