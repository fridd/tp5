...
<div class="about">
    <div class="container">
        <h1><?php echo ($this_article["category"]); ?></h1>
    </div>
</div>
...
<div class="about_grid">
    <div class="container">
        <?php if(is_array($categories)): $i = 0; $__LIST__ = $categories;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><h4 class="tz-title-4 tzcolor-blue col-md-2">
            <p class="tzweight_Bold <?php if($this_article[cat_id] == $v[id]): ?>selected<?php endif; ?>"><a href="<?php echo ($v["url"]); ?>"><?php echo ($v["cat_name"]); ?></a></p>
        ...
        <div class="blog">
            <div class="blog_top">
                <img src="/Public/images/home/article.jpg" class="img-responsive" alt="">
                <h3><a href="#"><?php echo ($this_article["title"]); ?></a></h3>
                <h4> Date : <?php echo ($this_article["public_date"]); ?> | 浏览 : <?php echo ($this_article["hits"]); ?></h4>
                <div class="context">
                    <?php echo ($this_article["content"]); ?>
                </div>
            </div>
        </div>
    </div>
